...
//bu sayfayı bulmak için: https://raw.githubusercontent.com/Biuni/PokemonGO-Pokedex/master/pokedex.json daki 2. elemanı aldık
// sonra onu  https://app.quicktype.io/  sitesinden dart a çevirdik
...
class PokemonModel {
  PokemonModel({
    //? ben null olaiblirim demek.  ! ise ben null değilim demek.
    this.id,
    this.num,
    this.name,
    this.img,
...
//bu kısım hiç yoktu biz ekledik. çünkü ekrana yazdıramadık.
  @override
  String toString() {
    return name!; // bunun null olmadığını biliyoruz. o yüzden sonuna ünlem ekledim.
  }
//üstteki kısım hiç yoktu.
...
class Evolution {
  ...
  @override //Evolution bir Class. model üzerinden bu classın sadece ismini çağırmak istediğimiz için böyle bir yapı oluşturduk. Aksi halde çağıramıyoruz Evalutionı
  String toString() {
